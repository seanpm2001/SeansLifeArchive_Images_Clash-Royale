---
Installing SeansLifeArchive/Images/Clash Royale
---

SeansLifeArchive/Images/ClashRoyale currently doesn't require installation, it is just a collection of images and data. It is part of the Seanpm2001 Life Archive project, and for proper "installation" the repository should be placed under /SeansLifeArchive/<yourInstalledVersion>/Resources/Images/

If you want to load the project language file, you will need to have Elixir (language) installed (versions 1.0 or higher)
...
---
Install instructions file version: 1 (Sunday, August 22nd 2021 at 6:12 pm)
---
